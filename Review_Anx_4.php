...
if (isset($_POST['submit'])) 
{
	...
	$query1 = 
	"INSERT INTO `reviewing_anx_iv`(`ayear`,`1`,`2`,`3`,`3ai`,`4`,`5`,`5ai`,`6`,`6ai`, `signReviewOfficer`, `name`, `designationReview`, `placeReview`, `dateReview`, `createdDate`, `uid`) VALUES  ('$ayear','$a1','$a2','$a3','$ai3','$a4','$a5','$ai5','$a6','$ai6','$signReviewOfficer', '$name', '$designation','$placeReview', '$dateReview', now(), '$uid')";
...
if (!empty($_GET['uid'])) {
	...
	$uid = $_GET['uid'];
	$query = $sql = "select * from user1 u1 INNER JOIN self_anx_iv r join reporting_anx_iv s  on u1.uid=r.uid and u1.uid=s.uid WHERE u1.uid = $uid AND r.ayear = $ayear AND s.ayear = $ayear";
