...
if (isset($_POST['submit'])) 
{
	...
	"INSERT INTO `accept_anx_i`(`ayear`, `railway`, `department`, `name`, `designation`, `1`, `1ai`, `2a`, `2b`, `2c`, `2d`, `2e`, `remarkByReview`, `stationReview`, `designationReview`, `dateReview`, `remarkByHod`, `stationHod`, `designationHod`, `dateHod`, `isArmy`, `createdDate`, `uid`) VALUES   ('$ayear','$railway','$department','$name','$designation','$a1','$ai1','$a2' ,'$b2','$c2' ,'$d2', '$e2', '$remarkByReview','$stationReview','$designationReview','$dateReview',' $remarkByHod','$stationHod' ,'$designationHod', '$dateHod' , '$isArmy', now(), '$uid')";
		...
		$stmt->bindParam(":railway", $railway, PDO::PARAM_STR);
...
if (!empty($_GET['uid'])) {
	...
	$uid = $_GET['uid'];
	$query = "select * from user1 u1 INNER JOIN self_anx_i r join reporting_anx_i s JOIN reviewing_anx_i q on u1.uid=r.uid and u1.uid=s.uid and u1.uid=q.uid WHERE u1.uid = $uid AND r.ayear=$ayear AND s.ayear=$ayear AND q.ayear=$ayear ";
...
<div class="container" style="padding-top: 20px">
	<a type="button" style="float:left;" href="view_accept.php" class="btn btn-info">Back</a><br />
...
<td><input required type="text" readonly class="form-control" id="exampleFormControlInput1" name="railway" value="<?php echo $row['office']; ?>"></td></tr>
