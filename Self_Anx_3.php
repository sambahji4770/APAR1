...
if (isset($_POST['submit'])) 
{
	...
	$query1 = 
	"INSERT INTO `self_anx_iii`( `ayear`,`1`, `2`,`poepy`, `createdDate`, `uid`) VALUES ('$ayear','$a','$b','$poepy',now(),'$uid')";
...
<td><input required type="text" class="form-control" id="exampleFormControlInput1" name="1" id="1"></td>
</tr>
