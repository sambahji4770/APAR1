...
if (isset($_POST['submit'])) 
{
	...
	$query1 = 
	"INSERT INTO `self_anx_i`( `ayear`,`1`, `2`,`poepy`, `createdDate`, `uid`) VALUES ('$ayear','$a','$b','$poepy',now(),'$uid')";
...
<nav class="navbar navbar-inverse fixed-top">
  ...
  <div class="tab-content">
   ...
   <h6 style="text-align:center"><b>Part-I - Personal Data.</b></h6></div></td>
	</tr>
  ...
  <td width="50px"><label for="exampleFormControlInput1">6</label></td>
    <td><label for="exampleFormControlInput1">Date of  Appointment to Service:</label></td>
