 ...
 if (isset($_POST['submit'])) 
{
	...
	$query1 = 
	"UPDATE `reporting1800` SET `Reviewremark`='$Reviewremark',`Special`='$Special', `ReviewingName`='$ReviewingName',`ReviewingDesignation`='$ReviewingDesignation',`ReviewingDate`='$ReviewingDate' WHERE `uid`='$uid'";
 ...
 if (!empty($_GET['uid'])) {
	...
	$query = $sql = "select * from user1 u1 INNER JOIN reporting1800 r on u1.uid=r.uid WHERE u1.uid = $uid AND r.ayear=$ayear";
...
<body>
 ...
 <?php include 'header.php';?> 
   ...
   <div class="container" style="padding-top: 160px">
	...
	<a href="/APAR1" style="float:right;" class="btn btn-info">Logout</a>
	...
	<div class="form-group">
		<tr>
			...
			<td><label for="exampleFormControlTextarea1">Integrity</label> <label for="exampleFormControlTextarea1">(If integrity is "Beyond  dobtful" writes so. if there is  doubt or suspicion ,Leave item  blank & attach separte note on which an appropriate decision shall be  taken as per procedure.) </label></td>
	...
	<div class="form-group">
		...
		<div class="form-group">
		<tr>
			<td colspan="4"><label for="exampleFormControlTextarea1"> Review Remark</label></td>
	...
	<table>
		...
		<tr>
			...
			<td><input  type="text" readonly name="ReviewingDesignation" id="ReviewingDesignation" value="<?php echo $row['ReportingName']; ?>"></td>
			<td><label>Name</label></td>
		...
		<tr>
			...
			<td><input  type="text" readonly name="ReviewingDesignation" id="ReviewingDesignation" value="<?php echo $row['ReportingDesignation']; ?>"></td>
			<td><label>Designation</label></td>
		...
		<tr><td><label>Date</label></td>			
			<td><input  type="text" readonly name="ReviewingDesignation" id="ReviewingDesignation" value=
			"<?php echo $row['ReportingDate']; ?>"></td>
